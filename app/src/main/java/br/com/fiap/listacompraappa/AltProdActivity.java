...
public class AltProdActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alt_prod);
    ...
    private void alterarProduto() {
        ...
        System.out.println("Pesquisar produto: "+ etxNome.getText().toString());
...
//        }
    ...
    private void alterarBaseDados() {
        ...
        produto.setNome(etxNome.getText().toString());
                ...
                .enqueue(new Callback<Produto>() {
                    ...
                    public void onResponse(Call<Produto> alterarProduto, Response<Produto> response) {
                        ...
                        if(response.isSuccessful()) {
                            ...
                            MainActivity.setProdutoSearch(mAdapter.getListaProdutos());
//                            Toast.makeText(AltProdActivity.this,
//                                    R.string.alterado_sucesso, Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(AltProdActivity.this,
                                    R.string.erro_alterar_produto, Toast.LENGTH_SHORT).show();
